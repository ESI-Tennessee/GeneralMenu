...
[assembly: ExtensionApplication(typeof(AutoCAD_ESI_General_Menu.MyPlugin))]
...
namespace AutoCAD_ESI_General_Menu
{
    ...
    public class MyPlugin : IExtensionApplication
    {
        ...
        static string Root = SetRoot();
        
        public static string SetRoot()
        {
            //Root = @"R:\Common\AutoCAD\";
            if (Directory.Exists(@"R:\Common\AutoCAD\"))
                Root = @"R:\Common\AutoCAD\";
            else if (Directory.Exists(@"C:\Program Files\Autodesk\ESI Files\"))
                Root = @"C:\Program Files\Autodesk\ESI Files\";
